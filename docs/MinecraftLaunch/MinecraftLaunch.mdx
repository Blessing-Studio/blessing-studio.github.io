...
不过，如果你执意想要使用MinecraftLaunch 3.0+，请移步到这里查看[MinecraftLaunch 3.0+ 旧文档（GitHub）](https://github.com/Blessing-Studio/blessing-studio.github.io/tree/vitepress/docs)
:::
