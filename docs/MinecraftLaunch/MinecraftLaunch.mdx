...
<Link className="button button--secondary button--lg" to="https://github.com/Blessing-Studio/MinecraftLaunch/tree/vitepress/docs" style={{ height: 47, marginBottom: 20}}>
